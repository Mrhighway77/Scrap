#ESTE CÓDIGO VUELVE A ITINERAR EN LA MISMA PAGINA GUARDANDO LA MISMA INFORMACION 
...
# Número máximo de páginas a extraer
MAX_PAGES = 3
...
print('Datos guardados en datos_propiedades_paginación.xlsx')
